...
class SceneLoader
{
	...
	enum class FileProperty {
		...
		LightSamples = 61, Description = 62, Author = 63
	};

	static const int kPropertyListCount = 67;
	...
	const std::wstring FilePropertyList[kPropertyListCount] = {
		...
		L"samples", L"description", L"author"
	};
	...
	const FileProperty FilePropertyReference[kPropertyListCount] = {
        ...
        FileProperty::LightSamples, FileProperty::Description, FileProperty::Author
	};
